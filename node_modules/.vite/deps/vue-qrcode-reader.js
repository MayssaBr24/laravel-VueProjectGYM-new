...
var br = (r, o, i) => (Ar(r, o, "read from private field"), i ? i.call(r) : o.get(r));
var Co = (r, o, i) => {
  if (o.has(r))
    throw TypeError("Cannot add the same private member more than once");
  o instanceof WeakSet ? o.add(r) : o.set(r, i);
};
var $o = (r, o, i, c) => (Ar(r, o, "write to private field"), o.set(r, i), i);
var Dr = [
  ["aztec", "Aztec"],
  ["code_128", "Code128"],
  ["code_39", "Code39"],
...
var lt = (() => {
  ...
  return function(o = {}) {
    ...
    var U, W = false, R, D, X, k, M, A, le, ie;
    function be() {
      var e = U.buffer;
    ...
    var Ne = [], ze = 0, sn = (e) => {
      var t = new gt(e);
      return t.get_caught() || (t.set_caught(true), ze--), t.set_rethrown(false), Ne.push(t), hr(t.excPtr), t.get_exception_ptr();
    }, se = 0, cn = () => {
      L(0, 0);
      var e = Ne.pop();
      fr(e.excPtr), se = 0;
    ...
    var un = (e) => {
      ...
      var t = e.excPtr;
      throw e.get_rethrown() || (Ne.push(e), e.set_rethrown(true), e.set_caught(false), ze++), se = t, se;
    }, pn = (e, t, n) => {
      var a = new gt(e);
    ...
    var ke = (e) => typeof FinalizationRegistry > "u" ? (ke = (t) => t, e) : (_t = new FinalizationRegistry((t) => {
      ...
      Object.assign(Xe.prototype, {
        ...
        deleteLater() {
          return this.$$.ptr || $t(this), this.$$.deleteScheduled && !this.$$.preservePointerOnDelete && x("Object already scheduled for deletion"), De.push(this), De.length === 1 && xe && xe(St), this.$$.deleteScheduled = true, this;
        }
      });
    };
    function Xe() {
...
` + s.replace(/^Error(:[^\n]*)?\n/, ""));
      ...
      Pt(O, function() {
        ...
        j = j[0];
        var q, I;
        a ? (q = j.registeredClass, I = q.instancePrototype) : I = Xe.prototype;
        var J = Ie(_, function() {
        ...
        var Se = new Ze(_, P, true, false, false), nt = new Ze(_ + "*", P, false, false, false), gr = new Ze(_ + " const*", P, false, true, false);
        return Jt[e] = {
          pointerType: nt,
          constPointerType: gr
        }, Zt(O, J), [Se, nt, gr];
    ...
    }, ja = (e) => e, tt = (e) => e % 4 === 0 && (e % 100 !== 0 || e % 400 === 0), Ha = (e, t) => {
    ...
    var qa = (e, t) => {
      ...
      function q(y) {
        var P = Ba(new Date(y.tm_year + 1900, 0, 1), y.tm_yday), N = new Date(P.getFullYear(), 0, 4), G = new Date(P.getFullYear() + 1, 0, 4), Se = j(N), nt = j(G);
...
`,
    ...
    var Ga = {
      ...
      ga: ja,
      S: za
    }, z = on(), ue = i._free = (e) => (ue = i._free = z.ka)(e), It = i._malloc = (e) => (It = i._malloc = z.la)(e), dr = (e) => (dr = z.na)(e), L = (e, t) => (L = z.oa)(e, t), Ue = (e) => (Ue = z.pa)(e), B = () => (B = z.qa)(), V = (e) => (V = z.ra)(e), fr = (e) => (fr = z.sa)(e), hr = (e) => (hr = z.ta)(e), pr = (e, t, n) => (pr = z.ua)(e, t, n), mr = (e) => (mr = z.va)(e);
    ...
    function yr() {
      if (te > 0 || (je(), te > 0))
        return;
      function e() {
        rt || (rt = true, i.calledRun = true, !W && (dt(), c(i), i.onRuntimeInitialized && i.onRuntimeInitialized(), ft()));
      }
...
var Le;
var Bt = class extends EventTarget {
  constructor(o = {}) {
    var i;
  ...
  async detect(o) {
    try {
      ...
      try {
        Lr(i) ? c = await Jo(i, {
          tryHarder: true,
          formats: br(this, Le).map((l) => st.get(l))
        }) : c = await Qo(i, {
          tryHarder: true,
          formats: br(this, Le).map((l) => st.get(l))
        });
...
var zr = async (r, o = ["qr_code"]) => await new Bt({ formats: o }).detect(r);
var ri = async (r, o = ["qr_code"]) => {
  ...
  setup(r, { emit: o }) {
      ...
      async (k) => {
        ...
        if (ae(le !== null, "if cavnas is defined, canvas 2d context should also be non-null"), k.shouldStream) {
          ...
          try {
            ...
            C.value ? (p.value = true, c("camera-on", ie)) : await it();
          } catch (ie) {
            c("error", ie);
          }
        } else
          A.width = M.videoWidth, A.height = M.videoHeight, le.drawImage(M, 0, 0, M.videoWidth, M.videoHeight), it(), p.value = false, c("camera-off");
      },
      { deep: true }
    ), watch(h, (k) => {
      C.value && Nr(k);
    ...
    const F = (k) => {
      ...
      if (ae(
        ...
        const le = A.offsetWidth, ie = A.offsetHeight, be = A.videoWidth, Ce = A.videoHeight, Oe = Math.max(le / be, ie / Ce), Me = be * Oe, je = Ce * Oe, dt = Me / be, ft = je / Ce, ht = (le - Me) / 2, pt = (ie - je) / 2, Ae = ({ x: de, y: Z }) => ({
          x: Math.floor(de * dt),
          y: Math.floor(Z * ft)
        }), te = ({ x: de, y: Z }) => ({
          x: Math.floor(de + ht),
